...
<div id="caixa2">
Experimento no qual um dos fatores, digamos <i>A</i>, é aleatorizado na parcela principal. Cada parcela principal é dividida em subparcelas de modo que os níves do fator <i>B</i> possam ser aleatorizados.
</div>
